# Continuous Integration [![tests](https://github.com/afroCoderHanane/continuous-integration/actions/workflows/tests.yml/badge.svg)](https://github.com/afroCoderHanane/continuous-integration/actions/workflows/tests.yml)
